...
export default function SimpleIcon({ type, size = 24 }: SimpleIconProps) {
  const getPath = () => {
    switch (type) {
      ...
      case 'briefcase':
        return "M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2-2v2m8 0H8m8 0v2a2 2 0 01-2 2H10a2 2 0 01-2-2V6m8 0H8";
      case 'folder':
