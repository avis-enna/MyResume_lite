...
export default function Contact({ contactData }: ContactProps) {
  ...
  return (
    <section id="contact" className={`py-20 px-6 lg:px-8 transition-colors duration-300 ${
      ...
      <div className="max-w-7xl mx-auto">
          ...
          <div>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <p className={`text-sm font-light tracking-wider uppercase transition-colors duration-300 ${
            ...
            <div className="flex space-x-6 mt-8">
              ...
              <a 
                href="https://github.com/avis-enna"
                className={`transition-colors duration-300 ${
                  isDarkMode ? 'text-gray-400 hover:text-white' : 'text-gray-600 hover:text-black'
                }`}
          ...
          <div>
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                <label 
                  htmlFor="name"
                  className={`block text-sm font-light tracking-wider uppercase mb-2 transition-colors duration-300 ${
                ...
                <input
                  ...
                  disabled={true}
                  className={`w-full px-4 py-3 border font-light transition-colors duration-300 cursor-not-allowed opacity-60 ${
                    isDarkMode 
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  disabled={true}
                  className={`w-full px-4 py-3 border font-light transition-colors duration-300 cursor-not-allowed opacity-60 resize-none ${
                    isDarkMode 
                      ? 'bg-gray-800 border-gray-600 text-gray-400' 
                      : 'bg-gray-100 border-gray-300 text-gray-500'
                  }`}
              ...
              <p className={`text-xs mt-3 text-center transition-colors duration-300 ${
                ...
                Having issues? Email me directly at {contactData.email || 'vsivareddy.venna@gmail.com'}
              </p>
            </form>
          </div>
        </div>
        ...
        <div className="text-center mt-20">
          ...
          <div className={`w-16 h-1 mx-auto transition-colors duration-300 ${
            isDarkMode ? 'bg-white' : 'bg-black'
          }`}></div>
          <p className={`mt-8 max-w-2xl mx-auto transition-colors duration-300 ${
            isDarkMode ? 'text-gray-300' : 'text-gray-600'
          }`}>
