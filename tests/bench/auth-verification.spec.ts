...
test.describe('Authentication Verification', () => {
  test('should maintain authenticated state across tests', async ({ authenticatedPage: page }) => {
  ...
  test('should handle session validation', async ({ authenticatedPage: page }) => {
  ...
  test('should access metrics dashboard', async ({ authenticatedPage: page }) => {
